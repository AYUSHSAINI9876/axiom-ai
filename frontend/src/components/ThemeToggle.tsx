...
export default function ThemeToggle() {
  ...
  return (
    <button
      type="button"
      onClick={cycleTheme}
      className="focus-ring glass flex h-9 w-9 items-center justify-center rounded-lg text-fg-muted transition-colors hover:text-fg"
      // The visible state is only an icon, so the label has to carry both what
      // it is now and what pressing it does.
